...
public class ElectricalStackMachineSelectableProcess implements IProcess {
    ...
    public interface ElectricalStackMachineProcessObserver {
        void done(ElectricalStackMachineSelectableProcess who);
    }
    ...
    public ElectricalStackMachineSelectableProcess(IInventory inventory, int inputSlotId, int inputSlotNbr, int OutputSlotId, int outputSlotNbr,
        ...
        inSlotIdList = new int[inputSlotNbr];
        for (int idx = 0; idx < inputSlotNbr; idx++) {
            inSlotIdList[idx] = idx + inputSlotId;
        }
    }
