...
public class ElectricalMachineTwoSlotElement extends TransparentNodeElement implements ElectricalStackMachineProcessObserver, IConfigurable {
    ...
    private final ElectricalMachineTwoSlotSlowProcess slowProcess = new ElectricalMachineTwoSlotSlowProcess(this);
    private boolean powerOn = false;
    final ElectricalMachineTwoSlotDescriptor descriptor;
    ...
    public ElectricalMachineTwoSlotElement(TransparentNode transparentNode, TransparentNodeDescriptor descriptor) {
    ...
    public Container newContainer(@NotNull Direction side, @NotNull EntityPlayer player) {
        return new ElectricalMachineTwoSlotContainer(this.node, player, inventory, descriptor);
    }
