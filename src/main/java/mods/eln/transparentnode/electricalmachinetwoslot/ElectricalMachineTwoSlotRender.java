...
public class ElectricalMachineTwoSlotRender extends TransparentNodeElementRender {
        ...
        if (this.descriptor.runningSound != null) {
            addLoopedSound(new LoopedSound(this.descriptor.runningSound, coordinate(), ISound.AttenuationType.LINEAR) {
                ...
                public float getVolume() {
                    return ElectricalMachineTwoSlotRender.this.descriptor.volumeForRunningSound(processState, powerFactor);
                }
            });
        }
    }
    ...
    public GuiScreen newGuiDraw(@NotNull Direction side, @NotNull EntityPlayer player) {
        return new ElectricalMachineTwoSlotGuiDraw(player, inventory, this);
    }
