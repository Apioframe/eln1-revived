...
public class ElectricalMachineTwoSlotDescriptor extends TransparentNodeDescriptor implements IPlugIn {
    ...
    ElectricalMachineTwoSlotDescriptor(String name, double nominalU, double nominalP, double maximalU,
                                       ThermalLoadInitializer thermal, ElectricalCableDescriptor cable,
                                       RecipesList recipe) {
        super(name, ElectricalMachineTwoSlotElement.class, ElectricalMachineTwoSlotRender.class);
        outStackCount = 4;
    ...
    public ElectricalMachineTwoSlotDescriptor setRunningSound(String runningSound) {
        this.runningSound = runningSound;
        return this;
    }

    public ElectricalMachineTwoSlotDescriptor setEndSound(SoundCommand endSound) {
