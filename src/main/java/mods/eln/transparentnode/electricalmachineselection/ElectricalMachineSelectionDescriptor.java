...
public class ElectricalMachineSelectionDescriptor extends TransparentNodeDescriptor implements IPlugIn {
    ...
    ElectricalMachineSelectionDescriptor(String name, double nominalU, double nominalP, double maximalU,
                                         ThermalLoadInitializer thermal, ElectricalCableDescriptor cable,
                                         RecipesList recipe) {
        super(name, ElectricalMachineSelectionElement.class, ElectricalMachineSelectionRender.class);
        outStackCount = 0;
    ...
    public ElectricalMachineSelectionDescriptor setRunningSound(String runningSound) {
        this.runningSound = runningSound;
        return this;
    }

    public ElectricalMachineSelectionDescriptor setEndSound(SoundCommand endSound) {
