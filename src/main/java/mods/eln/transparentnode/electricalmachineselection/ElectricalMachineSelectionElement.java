...
public class ElectricalMachineSelectionElement extends TransparentNodeElement implements ElectricalStackMachineProcessObserver, IConfigurable {
    ...
    private final ElectricalMachineSelectionSlowProcess slowProcess = new ElectricalMachineSelectionSlowProcess(this);
    ...
    public Container newContainer(@NotNull Direction side, @NotNull EntityPlayer player) {
        return new ElectricalMachineSelectionContainer(this.node, player, inventory, descriptor);
    }
